...
class Mdb_base(object):
    ...
    def is_flag_set(self, flag):
        return is_flag_set(self.mdh, flag)

    def get_flag(self, flag):
        return get_flag(self.mdh, flag)

    def set_flag(self, flag, val):
        set_flag(self.mdh, flag, val)

    def add_flag(self, flag):
        add_flag(self.mdh, flag)

    def remove_flag(self, flag):
        remove_flag(self.mdh, flag)

    def get_flags(self):
        return get_flags(self.mdh)

    def get_active_flags(self):
        return get_active_flags(self.mdh)

    def set_flags(self, flags):
        set_flags(self.mdh, flags)

    def clear_all_flags(self):
        clear_all_flags(self.mdh)

    def is_image_scan(self):
        return is_image_scan(self.mdh)
